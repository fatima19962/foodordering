...
class AppConstants {
  ...
  // static const String baseUrl = 'https://shopingnow.ir';
  // static const String popularProductUri = '/api/product/list';
  // static const String recommendedProductUri = '/api/product/recommended';
  ...
  static const String baseUrl = 'https://foodorderingapp.shopingnow.ir';
